...
static struct neigh_table *neigh_tables;//一个neigh_table结构实例对应一个邻居协议，所有的实例都连接在全局链表neigh_tables中。对于arp协议，neigh_table结构实例是arp_tbl。
...
static struct neigh_sysctl_table {
	...
	char *dev_name;
} neigh_sysctl_template __read_mostly = {  /*/proc/sys/net/ipv4/neigh/eth 该路径下面可以设置这些变量的值 参考Linux 内核源码剖析- TCP.IP 实现, 樊东东, 莫澜, 上册, 2011(1)*/
	.neigh_vars = {
		{
